...
typedef struct example_sort_service_pure_QuicksortService_s {
    example_sort_service_QuicksortService_t *_otterop;
} example_sort_service_pure_QuicksortService_t;


static example_sort_service_pure_QuicksortService_t *example_sort_service_pure_QuicksortService_wrap(example_sort_service_QuicksortService_t *wrapped) {
    example_sort_service_pure_QuicksortService_t *this = GC_malloc(sizeof(example_sort_service_pure_QuicksortService_t));
...
example_sort_service_pure_QuicksortService_t *example_sort_service_pure_QuicksortService_new() {
    example_sort_service_pure_QuicksortService_t *this = GC_malloc(sizeof(example_sort_service_pure_QuicksortService_t));
    this->_otterop = example_sort_service_QuicksortService_new();
    return this;
}
...
char **example_sort_service_pure_QuicksortService_sort(example_sort_service_pure_QuicksortService_t *this, char **array, size_t array_cnt, size_t *_ret_cnt) {
    ...
    otterop_lang_Array_t * ret_otterop = example_sort_service_QuicksortService_sort(this->_otterop, _array);
...
*example_sort_service_pure_QuicksortService__to_example_sort_service_pure_SortService(example_sort_service_pure_QuicksortService_t *this) {
    return example_sort_service_pure_SortService_new(this,
        (char **(*)(void *, char **, size_t, size_t *)) example_sort_service_pure_QuicksortService_sort);
}
